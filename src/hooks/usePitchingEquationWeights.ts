...
const DEFAULTS: Record<string, number> = {
  ...
  p_era_bb_pct_weight: 0.30,          // refit 2026-08-11: walks = top run-prevention input (D1-FIP physics)
  p_era_hh_pct_weight: 0.15,
  p_era_in_zone_whiff_pct_weight: 0,  // dropped — redundant with whiff+Stuff+ (β≈0)
  ...
  p_whip_stuff_plus_weight: 0.25,    // refit 2026-08-11
  ...
  p_hr9_hh_pct_weight: 0.30,          // refit 2026-08-11 (hard_hit added)
