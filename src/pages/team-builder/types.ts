...
export type BuildPlayer = {
  ...
  // roster aggregations (oWAR sum, MV sum, NIL budget). Returners + existing
  // targets default true (preserves prior behavior). New search-added
  // targets land as false and flip to true when the coach clicks the "+"
  // icon on the target board row.
