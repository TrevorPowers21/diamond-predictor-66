...
interface Props extends PlayerTableRowSharedProps {
  ...
  // Defaults to "roster" so existing call sites that don't pass it stay on
  // today's roster-style rendering.
          ...
          (() => {
            ...
            if (isPitcherRow) {
              ...
              const skill =
                ...
                null;
              const prv = p.prediction?.p_rv_plus ?? p.transfer_snapshot?.p_rv_plus ?? (sim as any)?.p_rv_plus ?? null;
