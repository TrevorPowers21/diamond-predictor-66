...
export function useTeamBuilderSimulation(params: UseTeamBuilderSimulationParams) {
  ...
  // countsTowardRoster lifted above positionPlayers — see comment there.
  ...
  // projection, and they still flow into the per-target-table totals below
  // (which are intentionally a "what if I added all of these?" view).
