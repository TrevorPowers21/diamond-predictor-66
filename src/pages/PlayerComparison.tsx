...
export default function PlayerComparison() {
  ...
  const [compareATeamSearch, setCompareATeamSearch] = useState("Arizona State");
  const [compareATeamOpen, setCompareATeamOpen] = useState(false);
  const [compareADestinationTeam, setCompareADestinationTeam] = useState("Arizona State");
  ...
  const [compareBTeamSearch, setCompareBTeamSearch] = useState("Arizona State");
