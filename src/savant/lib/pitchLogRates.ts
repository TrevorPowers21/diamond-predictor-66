...
const HITTER_XBA_LOOKUP: ReadonlyArray<readonly [number, number]> = [
  [0.1063, 0.0750], [0.1714, 0.1583], [0.1879, 0.1772], [0.1972, 0.1914],
  [0.2040, 0.2000], [0.2112, 0.2079], [0.2163, 0.2135], [0.2210, 0.2178],
  [0.2246, 0.2222], [0.2280, 0.2268], [0.2316, 0.2308], [0.2354, 0.2339],
  [0.2384, 0.2381], [0.2410, 0.2414], [0.2434, 0.2446], [0.2461, 0.2478],
  [0.2488, 0.2500], [0.2513, 0.2537], [0.2538, 0.2568], [0.2553, 0.2597],
  [0.2579, 0.2623], [0.2598, 0.2651], [0.2621, 0.2676], [0.2643, 0.2703],
  [0.2666, 0.2727], [0.2688, 0.2754], [0.2710, 0.2785], [0.2730, 0.2810],
  [0.2749, 0.2833], [0.2769, 0.2865], [0.2793, 0.2887], [0.2813, 0.2914],
  [0.2830, 0.2935], [0.2855, 0.2952], [0.2879, 0.2976], [0.2903, 0.3008],
  [0.2932, 0.3034], [0.2956, 0.3065], [0.2982, 0.3099], [0.3009, 0.3133],
  [0.3035, 0.3163], [0.3061, 0.3191], [0.3088, 0.3220], [0.3121, 0.3265],
  [0.3157, 0.3306], [0.3199, 0.3371], [0.3257, 0.3429], [0.3321, 0.3495],
  [0.3389, 0.3581], [0.3509, 0.3729], [0.4154, 0.4485],
];

const HITTER_XSLG_LOOKUP: ReadonlyArray<readonly [number, number]> = [
  [0.1148, 0.0980], [0.2350, 0.2154], [0.2595, 0.2500], [0.2734, 0.2647],
  [0.2867, 0.2771], [0.2941, 0.2892], [0.3025, 0.2991], [0.3110, 0.3071],
  [0.3180, 0.3154], [0.3240, 0.3224], [0.3303, 0.3299], [0.3359, 0.3367],
  [0.3426, 0.3429], [0.3479, 0.3497], [0.3536, 0.3562], [0.3594, 0.3626],
  [0.3651, 0.3689], [0.3702, 0.3756], [0.3742, 0.3805], [0.3789, 0.3860],
  [0.3832, 0.3919], [0.3883, 0.3968], [0.3935, 0.4023], [0.3975, 0.4066],
  [0.4017, 0.4123], [0.4073, 0.4186], [0.4124, 0.4244], [0.4159, 0.4316],
  [0.4214, 0.4366], [0.4263, 0.4422], [0.4312, 0.4471], [0.4374, 0.4525],
  [0.4428, 0.4593], [0.4497, 0.4667], [0.4559, 0.4739], [0.4612, 0.4798],
  [0.4676, 0.4866], [0.4725, 0.4925], [0.4782, 0.5000], [0.4851, 0.5057],
  [0.4947, 0.5152], [0.5047, 0.5263], [0.5134, 0.5357], [0.5229, 0.5469],
  [0.5357, 0.5588], [0.5477, 0.5704], [0.5668, 0.5844], [0.5867, 0.6045],
  [0.6140, 0.6310], [0.6550, 0.6723], [0.8791, 1.1569],
];

const HITTER_XWOBA_LOOKUP: ReadonlyArray<readonly [number, number]> = [
  [0.1575, 0.1291], [0.2406, 0.2289], [0.2602, 0.2482], [0.2715, 0.2605],
  [0.2786, 0.2681], [0.2852, 0.2773], [0.2905, 0.2833], [0.2952, 0.2892],
  [0.3004, 0.2944], [0.3044, 0.2992], [0.3084, 0.3029], [0.3110, 0.3064],
  [0.3144, 0.3102], [0.3180, 0.3137], [0.3211, 0.3169], [0.3251, 0.3203],
  [0.3277, 0.3241], [0.3301, 0.3276], [0.3331, 0.3307], [0.3358, 0.3337],
  [0.3385, 0.3369], [0.3410, 0.3398], [0.3435, 0.3430], [0.3465, 0.3457],
  [0.3492, 0.3479], [0.3514, 0.3509], [0.3535, 0.3537], [0.3555, 0.3564],
  [0.3582, 0.3599], [0.3602, 0.3628], [0.3628, 0.3655], [0.3650, 0.3683],
  [0.3683, 0.3713], [0.3711, 0.3742], [0.3735, 0.3776], [0.3766, 0.3812],
  [0.3799, 0.3842], [0.3827, 0.3877], [0.3865, 0.3914], [0.3902, 0.3953],
  [0.3940, 0.3992], [0.3976, 0.4041], [0.4013, 0.4079], [0.4058, 0.4123],
  [0.4105, 0.4167], [0.4158, 0.4226], [0.4233, 0.4296], [0.4331, 0.4400],
  [0.4457, 0.4527], [0.4641, 0.4719], [0.5676, 0.6706],
];

const PITCHER_XBA_LOOKUP: ReadonlyArray<readonly [number, number]> = [
  [0.1282, 0.1091], [0.1925, 0.1789], [0.2068, 0.1923], [0.2160, 0.2025],
  [0.2216, 0.2090], [0.2262, 0.2158], [0.2316, 0.2213], [0.2355, 0.2261],
  [0.2390, 0.2300], [0.2419, 0.2335], [0.2450, 0.2370], [0.2479, 0.2403],
  [0.2508, 0.2436], [0.2539, 0.2464], [0.2564, 0.2492], [0.2588, 0.2519],
  [0.2609, 0.2551], [0.2635, 0.2578], [0.2655, 0.2601], [0.2676, 0.2624],
  [0.2696, 0.2646], [0.2715, 0.2671], [0.2736, 0.2706], [0.2756, 0.2727],
  [0.2770, 0.2759], [0.2790, 0.2788], [0.2807, 0.2813], [0.2824, 0.2841],
  [0.2844, 0.2866], [0.2862, 0.2886], [0.2881, 0.2913], [0.2900, 0.2937],
  [0.2922, 0.2963], [0.2938, 0.2990], [0.2959, 0.3021], [0.2983, 0.3053],
  [0.3007, 0.3087], [0.3033, 0.3118], [0.3055, 0.3146], [0.3081, 0.3187],
  [0.3110, 0.3226], [0.3147, 0.3258], [0.3179, 0.3303], [0.3215, 0.3354],
  [0.3255, 0.3418], [0.3304, 0.3491], [0.3362, 0.3562], [0.3431, 0.3647],
  [0.3525, 0.3793], [0.3681, 0.4000], [0.5231, 0.5231],
];

const PITCHER_XSLG_LOOKUP: ReadonlyArray<readonly [number, number]> = [
  [0.1518, 0.1455], [0.2883, 0.2540], [0.3077, 0.2857], [0.3233, 0.3032],
  [0.3333, 0.3146], [0.3426, 0.3255], [0.3501, 0.3333], [0.3580, 0.3404],
  [0.3637, 0.3473], [0.3690, 0.3543], [0.3751, 0.3608], [0.3798, 0.3656],
  [0.3849, 0.3714], [0.3894, 0.3774], [0.3942, 0.3811], [0.3976, 0.3860],
  [0.4020, 0.3913], [0.4062, 0.3966], [0.4097, 0.4018], [0.4133, 0.4063],
  [0.4176, 0.4110], [0.4208, 0.4151], [0.4246, 0.4196], [0.4280, 0.4239],
  [0.4315, 0.4276], [0.4346, 0.4323], [0.4375, 0.4366], [0.4416, 0.4417],
  [0.4451, 0.4464], [0.4493, 0.4519], [0.4528, 0.4576], [0.4561, 0.4626],
  [0.4604, 0.4667], [0.4648, 0.4712], [0.4689, 0.4766], [0.4734, 0.4831],
  [0.4777, 0.4896], [0.4829, 0.4944], [0.4887, 0.5000], [0.4944, 0.5094],
  [0.4995, 0.5167], [0.5063, 0.5246], [0.5133, 0.5345], [0.5196, 0.5439],
  [0.5278, 0.5563], [0.5372, 0.5695], [0.5493, 0.5849], [0.5643, 0.6080],
  [0.5847, 0.6341], [0.6158, 0.6818], [0.9186, 0.9333],
];
