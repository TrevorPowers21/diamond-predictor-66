...
export const REPLACEMENT_RUNS_PER_600PA = 21.22; // 1.62 wins/600 × RPW 13.1 — DERIVED 2026-08-11 from the .380
// win% anchor (same principle as the pitcher floor RA9 8.83), verified vs the empirical D1 depth tier. Was 2.0 (borrowed MLB).
