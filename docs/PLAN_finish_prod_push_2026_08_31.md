...
## ✅ STEP 7a/7b — E36 pitchers + E37 hitters — **DONE 2026-08-31** (re-run after the depth-role fix; tiers now REG-anchored) · ▶️ **NEXT: E38 transfers** (`zsh scripts/_run_step2_all.sh --prod`) (read the Masters — hence STEP 2/4 first)
```
